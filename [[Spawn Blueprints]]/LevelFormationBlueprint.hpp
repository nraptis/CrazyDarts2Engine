...
public:
    ...
    static int                                  CountObjectsOfType(const char *pFormationID, int pGameObjectType);
    
    static LevelFormationBlueprint              *GetFormation(const char *pFormationID);
